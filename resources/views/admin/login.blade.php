                    ...
                    <div class="p-3">
                        ...
                        <form action="{{ route('login') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control @if(count($errors) > 0) is-invalid @endif" value="{{old('username')}}"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    <input type="password" id="password" name="password" class="form-control @if(count($errors) > 0) is-invalid @endif" placeholder="Enter your password">
